        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#filter').on('change', function () {
                    if($('#filter').val() == 1) {
                        window.location.href = '/human.php?status=1';
                    }else if($('#filter').val() === '0') {
                        window.location.href = '/human.php?status=0';
                    }else{
                        window.location.href = '/human.php';
                    }
                });
                $('.edit').on('click', function() {
                    ...
                    $.ajax({
                        url:'/save.php',
                        data:{'type':'Human','key':parseInt(key), 'name':data},
                        type:'POST',
